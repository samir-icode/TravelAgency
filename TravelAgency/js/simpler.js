...
function myFunction() {
  if (document.body.scrollTop > 250 || document.documentElement.scrollTop > 250) {
    ...
    var txt =document.getElementsByClassName("txt-slide");
  ...
  if (document.body.scrollTop > 375 || document.documentElement.scrollTop > 375) {
    ...
    var imgs =document.getElementsByClassName("img-slide-down");
    var txt =document.getElementsByClassName("txt-slide-down");
         
          for(var i=0;i<imgs.length;i++) {
             imgs[i].className = "slideUpX";
             
          }

          for(var i=0;i<txt.length;i++) {
             txt[i].className = "slideUpX";
